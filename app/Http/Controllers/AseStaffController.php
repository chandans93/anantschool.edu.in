...
Class SMTPMailer
{
    ...
    public function __construct($server=false, $port=false, $secure=false)
    {
        ...
        $this->port     = 587;
        $this->secure   = 'tls';
        $this->username = 'events@anantschool.edu.in';
        $this->password = 'mCD<j6RB';
...
class AseStaffController extends Controller
{
    ...
    public function class11()
    {
       
       return view('front.class11');
    }
     public function classscience()
    {
       
       return view('front.classscience');
    }
    public function classarts()
    {
       
       return view('front.classarts');
    }
    public function classcommerce()
    {
       
       return view('front.classcommerce');
    }

    public function class11formsubmit(Request $req)
    {
