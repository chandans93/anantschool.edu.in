       ...
       <div class="container" style="background-color: lightblue; text-align: center; color: white;">
          <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 ">
               <b class="logo">REGISTRATION FORM CLASS XI ( Science )</b>
            </div>
              <div >
                  <form action="{{asset('/student/class11/submit')}}" method="post" name="class11" style="font-size: 20px; text-align: left;" onsubmit="return validateForm()">
                    {{ csrf_field() }}
                    <input type="hidden" id="stream" name="stream" value="1">
                    <input type="hidden" name="opp2" value="NA">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      <div class='col-md-12 col-lg-12 col-sm-12' style='padding: 10px;'><label>Compulsory Subject</label></div><div class='col-md-12 col-lg-12 col-sm-12'><div class='col-md-4 col-lg-4 col-sm-12'>ENGLISH</div><div class='col-md-4 col-lg-4 col-sm-12'>PHYSICS</div><div class='col-md-4 col-lg-4 col-sm-12'>CHEMISTRY</div><div class='col-md-4 col-lg-4 col-sm-12'>COMPUTER</div></div><div class='col-md-12 col-lg-12 col-sm-12' style='padding-bottom: 10px;'><strong>Optional Subjects ( Please Select Any One Subject )</strong></div><div class='col-md-12 col-lg-12 col-sm-12'><div class='form-group'><label class='radio-inline'><input type='radio' id='MATHEMATICS' name='opp1' value='MATHEMATICS' required>MATHS.</label><label class='radio-inline'><input type='radio' id='BIOLOGY' name='opp1' value='BIOLOGY'>BIOLOGY</label></div></div>                
                    </div>
