       ...
       <div class="container" style="background-color: lightblue; text-align: center; color: white;">
          <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 ">
               <b class="logo">REGISTRATION FORM CLASS XI ( Commerce )</b>
            </div>
              <div >
                  <form action="{{asset('/student/class11/submit')}}" method="post" name="class11" style="font-size: 20px; text-align: left;" onsubmit="return validateForm()">
                    ...
                    <input type="hidden" name="opp3" value="NA">
                    <input type="hidden" name="opp4" value="NA">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                      <div class='col-md-12 col-lg-12 col-sm-12'><label>Compulsory Subject</label>
                      </div>
                        <div class='col-md-12 col-lg-12 col-sm-12' style='padding: 10px;'>
                           <div class='col-md-4 col-lg-4 col-sm-12'>ENGLISH</div>
                           <div class='col-md-4 col-lg-4 col-sm-12'>ACCOUNTANCY</div>
                           <div class='col-md-4 col-lg-4 col-sm-12'>BUSINESS STUDIES</div>
                           <div class='col-md-4 col-lg-4 col-sm-12'>STATASTICS</div>
                           <div class='col-md-4 col-lg-4 col-sm-12'>ECONOMICS</div>
                        </div>
                        <div class='col-md-12 col-lg-12 col-sm-12'style='padding: 10px;'>
                          <strong>Optional Subjects ( Please Choose Any One Subject From Each Row )</strong></div>
                        <div class='col-md-12 col-lg-12 col-sm-12'>
                           <div class='form-group'><label class='radio-inline'><input type='radio' id='MATHEMATICS' name='opp1' value='HINDI' required> HINDI</label><label class='radio-inline'><input type='radio' id='GUJARATI' name='opp1' value='GUJARATI'>GUJARATI</label></div>
                        </div>
                        <div class='col-md-12 col-lg-12 col-sm-12'>
                           <div class='form-group'><label class='radio-inline'><input type='radio' id='COMPUTER' name='opp2' value='COMPUTER' required> COMPUTER</label><label class='radio-inline'><input type='radio' id='SPCC' name='opp2' value='SPCC'> S.P.C.C</label>
                           </div>
                        </div>                 
                    </div>
